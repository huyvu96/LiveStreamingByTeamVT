...
export default StyleSheet.create({
    ...
    viewChat:{position: 'absolute',right: 0,left: height/60,bottom: height/9,zIndex:100,width: width/2, height:height/5, justifyContent:'flex-end'},
    styleTextChat:{ marginLeft: 5, color: 'white', fontSize: height/40, opacity: 1},
    viewFuntionVideo:{position: 'absolute',right: 5,bottom: height / 9,zIndex:100,alignItems:'center'},
